...
class App(BaseHTTPRequestHandler):
    ...
    def practice(self,user,pid):
        ...
        elif not p['data_complete']:
            pdf_block = '<div class="flash warning">Completa i dati obbligatori prima di assegnare il numero DDT.</div>'
        else:
            pdf_block = f'<div class="actions"><a class="btn ghost" href="/pratiche/{pid}/ddt-bozza.pdf">Genera PDF senza numero</a><form method="post" action="/pratiche/{pid}/ddt"><button class="btn">Assegna numero e genera PDF definitivo</button></form></div><p class="sub">La numerazione DDT è unica e condivisa tra le sedi; può essere assegnata anche in un secondo momento.</p>'
