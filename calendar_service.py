...
def normalize_event(form, current=None):
    ...
    if event_type=="Ritiro":
        ...
        # L'indirizzo esatto puo' non essere ancora noto al momento della
        # creazione dell'evento (richiesta esplicita dell'utente): resta
        # compilabile/modificabile in seguito, non blocca piu' il salvataggio.
